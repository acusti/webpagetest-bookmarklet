...
(function() {
  ...
  var WPTForm = React.createClass({displayName: "WPTForm",
    ...
    render: function() {
      var fieldNodes = this.state.fields.map(function(field) {
        return (
          React.createElement(WPTField, {key: field.key, id: field.key, label: field.label, value: field.value, type: field.type, options: field.options, required: field.isRequired})
        );
      });
      return (
        React.createElement("form", {style: styles.form, onSubmit: this.handleSubmit, onChange: this.handleChange}, 
          React.createElement(WPTCloseButton, null), 
          React.createElement("h2", {style: styles.h2}, 
            "Run WebPageTest for this page"
          ), 
          fieldNodes, 
          React.createElement("button", {type: "submit", style: styles.button}, "Test it")
        )
      );
    },
  ...
  var WPTCloseButton = React.createClass({displayName: "WPTCloseButton",
    ...
    render: function() {
      return (
        React.createElement("button", {style: styles.closeButton, onClick: this.handleClick}, 
          "Close", 
          React.createElement("svg", {style: styles.closeButtonIcon, viewPort: "0 0 12 12", version: "1.1", xmlns: "http://www.w3.org/2000/svg"}, 
